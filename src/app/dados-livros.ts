...
export const LIVROS = [
 // Primeiro livro: 1984
 {
  ...
  // Quinto livro: Percy Jackson - O Ladrão de Raios
  {
    ...
    categoria: 'Infantil',
    ano: 2005,
    capa: 'https://covers.openlibrary.org/b/isbn/0439765935-L.jpg',
    lido: true,
  ...
  // Sexto livro: Dom Casmurro
  {
    ...
    categoria: 'Ficção',
    ano: 1899,
    capa: 'https://covers.openlibrary.org/b/isbn/8532509559-L.jpg',
    lido: true,
  ...
  // Sétimo livro: Harry Potter - A Pedra Filosofal
  {
    ...
    categoria: 'Infantil',
    ano: 1997,
    capa: 'https://covers.openlibrary.org/b/isbn/043913959X-L.jpg',
    lido: true,
