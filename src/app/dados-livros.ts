...
export const LIVROS = [
 // Primeiro livro: 1984
 {
    ...
    ano: 1949,
    capa: 'https://covers.openlibrary.org/b/isbn/0451524934-M.jpg',
  ...
  // Segundo livro: O Principezinho
  {
    ...
    categoria: 'Infantil',
    ano: 1943,
    capa: 'https://covers.openlibrary.org/b/isbn/0156012197-M.jpg',
    lido: false,
  ...
  // Terceiro livro: O Código Da Vinci
  {
    ...
    categoria: 'Ficção',
    ano: 2003,
    capa: 'https://covers.openlibrary.org/b/isbn/0385504209-M.jpg',
    lido: true,
  ...
  // Quarto livro: O Hobbit
  {
    ...
    categoria: 'Fantasia',
    ano: 1937,
    capa: 'https://covers.openlibrary.org/b/isbn/0007458428-M.jpg',
    lido: false,
  ...
  // Quinto livro: Percy Jackson - O Ladrão de Raios
  {
    ...
    categoria: 'Infantil',
    ano: 2005,
    capa: 'https://covers.openlibrary.org/b/isbn/0439765935-M.jpg',
    lido: false,
  ...
  // Sexto livro: Dom Casmurro
  {
    ...
    categoria: 'Ficção',
    ano: 1899,
    capa: 'https://covers.openlibrary.org/b/isbn/8532509559-M.jpg',
    lido: true,
  ...
  // Sétimo livro: Harry Potter - A Pedra Filosofal
  {
    ...
    categoria: 'Infantil',
    ano: 1997,
    capa: 'https://covers.openlibrary.org/b/isbn/043913959X-M.jpg',
    lido: true,
