...
export class Tab3Page {
  ...
  autor = {
    ...
    // Opção 1: Coloca a tua foto em src/assets/ e usa: 'assets/nome-do-ficheiro.jpg'
    // Opção 2: Usa um URL online: 'https://www.exemplo.com/foto.jpg'
    foto: 'https://ionicframework.com/docs/img/demos/avatar.png', // Substitui este URL pela tua foto
